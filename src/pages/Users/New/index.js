...
class UserRegistration extends Component {
    ...
    handleSaveUser = () => {
        const {username, name, email, city, rideInGroup, daysOfTheWeek, posts} = this.state
            ...
            <Grid container className={classes.externalContainer} direction="column">
                <Grid item>
                    ...
                    <Grid
                        ...
                        spacing={9}
                        className={classes.registrationHelper}>
                        <Grid xs={4} item className={classes.helpContainer}>
                        ...
                        <Grid item xs={4} x className={classes.helpContainer}>
                            <Grid container spacing={2} direction="column">
                                <Grid item>
                                    <Typography variant="h5" className={classes.helpText}>
                                        Why register?
                                ...
                                <Grid item>
                                    <Grid container direction="row">
                                        <Grid item className={classes.buttonsContainer}>
                                            <Button className={classes.saveButton} onClick={this.handleSaveUser}>
                                                Save
                                            </Button>
                                        </Grid>
                                        <Grid item>
                                            <Button className={classes.discardButton} onClick={this.handleDiscardUser}>
                                                Discard
                                            </Button>
                                        </Grid>
                                    </Grid>
